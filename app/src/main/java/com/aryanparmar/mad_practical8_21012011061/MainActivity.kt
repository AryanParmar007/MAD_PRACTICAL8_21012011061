package com.aryanparmar.mad_practical8_21012011061
...
class MainActivity : AppCompatActivity() {
    ...
    fun set_alarm(militime:Long,action:String){
        ...
        val
                pendingintent=PendingIntent.getBroadcast(applicationContext,2345,intent_alarm,PendingIntent.FLAG_UPDATE_CURRENT)
